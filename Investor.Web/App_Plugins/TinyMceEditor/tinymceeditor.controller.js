...
function TinyMceEditorController($element, $rootScope, $scope, $q, dialogService, $log, imageHelper, assetsService, $timeout, tinyMceService, angularHelper, stylesheetResource, macroService) {
    ...
    var d = new Date();
    var n = d.getTime();
    $scope.textAreaHtmlId = "wmd_" + $scope.model.alias + "_" + n + "_rte";
